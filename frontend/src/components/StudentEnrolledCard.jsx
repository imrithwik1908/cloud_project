...
function StudentEnrolledCard({ courseName, courseCode, credits, professorName }) {
  return (
    <div className="max-w-sm w-full rounded-lg shadow-lg bg-gray-100 p-6 m-4 hover:shadow-2xl transform hover:scale-103 transition h-60 duration-100 ease-in-out">
